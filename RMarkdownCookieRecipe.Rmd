...
This festive R Markdown document demonstrates how you can combine text, code, and tables — with a Christmas cookie recipe as an example.

## Christmas Sugar Cookies

These classic sugar cookies are simple, delicious, and perfect for decorating.
...
4. Mix dry ingredients separately, then slowly combine with wet mixture.
...
Here's a simple R code chunk that scales the ingredient quantities if you want to make more (or fewer!) cookies.
...
The table above shows how much of each ingredient you'd need to make 60 cookies.


## Final Notes

* This example shows how GitHub can version-control reproducible documents.
